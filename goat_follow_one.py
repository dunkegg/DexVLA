...
if __name__ == '__main__':
    ...
    for file_name, content in sorted(data.items()):
        ...
        human_fps = 10
        human_speed = 0.7
        followed_path = generate_path_from_scene(episode_data, pathfinder, 5, human_fps, human_speed)
        for human_idx in range(100):
            ...
            humanoid_name = name_folders[human_idx]
            ...
            vut.make_video(
                ...
                "color_0_0",
                "color",
                f"{video_output}/humanoid_wrapper_{humanoid_name}",
                open_vid=False,
            )
            print(f"Case {human_idx}, {humanoid_name} Done, Already has {episodes_count} cases")
