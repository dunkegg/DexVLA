...
#             frames.append(img)
#         current_img_path = history_image_seq[start_ts].decode('utf-8')
#         current_img_path = current_img_path.replace("/mnt/pfs/3zpd5q/", "/mnt/pfs/s7fsio/")
...
#     #
#     norm_stats, all_episode_len = get_norm_stats(stats_paths, print, config['data_args'].norm_json_path)
