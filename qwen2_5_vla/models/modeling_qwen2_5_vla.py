...
from .configuration_qwen2_5_vla import Qwen2_5_VLAConfig, Qwen2_5_VLAVisionConfig
import gc
...
if is_flash_attn_2_available():
    ...
    from transformers.modeling_flash_attention_utils import apply_rotary_emb, _flash_attention_forward
else:
    flash_attn_varlen_func = None

logger = logging.get_logger(__name__)

_CONFIG_FOR_DOC = "Qwen2_5_VLAConfig"
...
class Qwen2_5_VLPreTrainedModel(PreTrainedModel):
    config_class = Qwen2_5_VLAConfig
    base_model_prefix = "model"
    supports_gradient_checkpointing = True
    _no_split_modules = ["Qwen2_5_VLDecoderLayer", "Qwen2_5_VLVisionBlock", "policy_head"]
...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    config_class = Qwen2_5_VLAVisionConfig
...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    def __init__(
        ...
        scaling_factor=1.0,
        rope_type="default",
        config: Optional[Qwen2_5_VLAConfig] = None,
    ):
        super().__init__()
        self.rope_kwargs = {}
        if config is None:
...
class Qwen2_5_VLAttention(nn.Module):
    ...
    def __init__(self, config: Qwen2_5_VLAConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Qwen2_5_VLDecoderLayer(nn.Module):
    def __init__(self, config: Qwen2_5_VLAConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    def __init__(self, config: Qwen2_5_VLAConfig):
...
class Qwen2_5_VLForConditionalGenerationForVLA(Qwen2_5_VLPreTrainedModel, GenerationMixin):
...
AutoModelForCausalLM.register(Qwen2_5_VLAConfig, Qwen2_5_VLForConditionalGenerationForVLA)
