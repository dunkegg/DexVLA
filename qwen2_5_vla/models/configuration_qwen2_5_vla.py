...
class Qwen2_5_VLAVisionConfig(PretrainedConfig):
...
class Qwen2_5_VLAConfig(PretrainedConfig):
    r"""
    ...
    sub_configs = {"vision_config": Qwen2_5_VLAVisionConfig}
...
AutoConfig.register("qwen2_5_vla", Qwen2_5_VLAConfig)
