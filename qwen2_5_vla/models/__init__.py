...
if TYPE_CHECKING:
    from .configuration_qwen2_5_vla import Qwen2VLConfig
    ...
    try:
        ...
        from .modeling_qwen2_5_vla import (
    ...
    #     pass
    # else:
    #     from qwen2_vla.utils.image_processing_qwen2_vla import Qwen2VLImageProcessor
