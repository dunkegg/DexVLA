...
if __name__ == '__main__':
    ...
    policy_config = {
        ...
        "model_path": "/mnt/pfs/3zpd5q/code/mimo/DexVLA/OUTPUT/mimo_rxr_epsilon_v1/checkpoint-30000",
        # "model_path": "/mnt/pfs/3zpd5q/code/train/DexVLA/OUTPUT/qwen2_follow_real_finetune_on_sample_mirror_robot/checkpoint-4000",
        #############################################################################
    ...
    import os
    for k in range(0,23):
        folder_path = f'/mnt/pfs/3zpd5q/code/train/DexVLA/eval_plot/episode_{k}/sample'
        ...
        for i, frames in enumerate(grouped_paths):
            ...
            print(f"episode spend time {time.time() - start_time:.2f}s")
        # break
